# Contributing to MemAura

Thanks for improving the MemAura Python SDK.
...
PYTHONPYCACHEPREFIX=/private/tmp/memaura-pyc .venv/bin/python -m compileall -q memaura tests
...
The public package surface is the set exported by `memaura.__all__`. Keep new
